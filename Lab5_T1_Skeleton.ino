...
#define A  5 // Replace the ? with the GPIO pin you selected to connect encoder A
#define B  17 // Replace the ? with the GPIO pin you selected to connect encoder B
#define PWM 16  // Replace the ? with the GPIO pin you selected to output PWM
